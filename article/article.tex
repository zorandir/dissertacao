...
%Alias, será que você não quis dizer "for larger families of CAs" ao invés de "for a large number of families in CAs"?
...
% O PP não costuma curtir muito o termo "família". Normalmente usamos "espaço" mesmo. Ele provavelmente vai pedir pra vc mudar isso no artigo inteiro. hahahah
